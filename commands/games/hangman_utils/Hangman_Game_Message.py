...
from commands.games.hangman_utils.hangman_globals import HANGMAN_STAGES, hangman_games
...
class HangmanMessageEditor:
    ...
    async def build_hangman_embed(self, channel_id: int, game_over: bool = False, victory: bool = False) -> Optional[discord.Embed]:
        ...
        - Uses defensive reads from the shared game state.
        """
        ...
        correct: Set[str] = set(game.get("correct", set()))
        wrong: Set[str] = set(game.get("wrong", set()))
...
# Singleton editor
message_editor = HangmanMessageEditor()